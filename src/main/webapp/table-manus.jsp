												...
												<td>
													<div class="d-flex px-2 py-1">
														<div class="d-flex flex-column justify-content-center">
															<h6 class="mb-0 text-sm">${manufacturer.manufacturerName}</h6>
															<p class="text-xs text-secondary mb-0">ID:${manufacturer.manufacturerId}</p>
														</div>
													</div>
												</td>
												<td>
													<p class="text-xs font-weight-bold mb-0">${manufacturer.address}</p>
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0">0${manufacturer.phoneNumber}</p>
												</td>
