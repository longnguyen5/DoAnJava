				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div
							...
							<div class="site-logo">
								<a href="index.jsp" class="js-logo-clone">Dr.Anal</a>
							</div>
						</div>
			...
			<nav class="site-navigation text-right text-md-center"
				...
				<div class="container">
					<ul class="site-menu js-clone-nav d-none d-md-block">
						...
						<li class="has-children active"><a href="about.jsp">About</a>
							<ul class="dropdown">
								<li><a href="#">Menu One</a></li>
								<li><a href="#">Menu Two</a></li>
								<li><a href="#">Menu Three</a></li>
				...
				<div class="row mb-5">
					...
					<div class="col-md-5">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Eius repellat, dicta at laboriosam, nemo exercitationem itaque
							eveniet architecto cumque, deleniti commodi molestias repellendus
							quos sequi hic fugiat asperiores illum. Atque, in, fuga excepturi
						...
						<p>Accusantium dolor ratione maiores est deleniti nihil?
							...
							recusandae, laudantium minima repellendus.</p>
