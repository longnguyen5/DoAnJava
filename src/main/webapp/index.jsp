				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
						...
						<a href="#" class="block-6"> <img src="images/rickroll.jpg"
							...
							<h3 class="font-weight-light  mb-0">Tải ứng dụng trên điện
								thoại</h3>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<div class="block-5 mb-5">
							...
							<ul class="list-unstyled">
								<li class="address">Fake 154 Lê Duẩn, TP Vinh, Nghệ An</li>
								<li class="phone"><a href="tel://23923929210">+84 987
										635 612</a></li>
								<li class="email">nguyntnlong12@gmail.com</li>
							</ul>
						</div>
