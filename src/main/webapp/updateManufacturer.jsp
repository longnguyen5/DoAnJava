			...
			<div class="row">
				<div class="col-8" style="margin: 0 auto;">
					<div class="card mb-4">
						...
						<c:set value="${manufacturer}" var="c" />
						<form action="UpdateManuServlet" method="post">
							<div class="mb-3 ml-3 row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" name="manufacturerId"
										value="${c.manufacturerId}" readonly>
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" name="manufacturerName"
										value="${c.manufacturerName}" aria-label="default input example">
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" name="address"
										value="${c.address}" aria-label="default input example">
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								...
								<div class="col-sm-10">
									<input class="form-control" type="text" name="phoneNumber"
										value="${c.phoneNumber}" aria-label="default input example">
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								<div class="col-auto">
