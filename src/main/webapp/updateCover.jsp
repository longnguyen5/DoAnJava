			...
			<div class="row">
				<div class="col-8" style="margin: 0 auto;">
					<div class="card mb-4">
						...
						<form action="UpdateCoverServlet" method="post">
							<div class="mb-3 ml-3 row">
								<label for="coverId" class="col-sm-2 col-form-label">ID
									</label>
								<div class="col-sm-10">
									<input class="form-control" type="text" name="coverId"
										value="${c.coverId}" readonly>
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								<label for="coverName" class="col-sm-3 col-form-label">Tên
									</label>
								<div class="col-sm-10">
									<input class="form-control" type="text" name="coverName"
										value="${c.coverName}" aria-label="default input example">
								</div>
							</div>
							<div class="mb-3 ml-3 row">
								<label for="description" class="col-sm-3 col-form-label">Tên
									</label>
								<div class="col-sm-10">
									<input class="form-control" type="text" name="description"
										value="${c.description}" aria-label="default input example">
								</div>
							</div>
							<div class="mb-3 ml-3 row">
