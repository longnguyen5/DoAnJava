...
<script>
        ...
        function buy(id) {
            ...
            // Chỉnh sửa đường dẫn action của form và submit
            var buyform = document.getElementById("buyform");
            buyform.action = "BuyServlet?productId=" + id + "&quantity=" + m;
            buyform.submit();
        }
    </script>
</head>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="ProductServlet">Sản phẩm</a> <span class="mx-2 mb-0">/</span>
						<strong class="text-black">${c.productName}</strong>
					</div>
				</div>
			</div>
		</div>
            ...
            <div class="col-md-12">
                ...
                <div class="mb-5">
                    <div class="input-group mb-3" style="max-width: 120px;">
                        ...
                        <!-- Ensure the input field has the correct name and id -->
                ...
                <p>
                    <!-- Correct the function call to use the correct form ID -->
                    <a href="javascript:void(0);" onclick="buy('${c.productId}')" class="buy-now btn btn-sm btn-primary">Thêm vào giỏ</a>
                </p>
            </div>
        </form>
    </div>
...
<!-- <script>
    function buy(id) {
        var m = document.getElementById("num").value;
        var buyform = document.getElementById("buyform");
        // Chỉnh sửa đường dẫn action của form
        buyform.action = "BuyServlet?productId=" + id + "&quantity=" + m;
        buyform.submit();
    }
</script> -->
